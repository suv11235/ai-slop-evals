...
- **CGF–FGF adversarial game** (Coarse-Grained Functionalism vs Fine-Grained Functionalism) as a multi-turn generator of “patch vs counter” trajectories:
  - Strategy: `docs/cgf_fgf_strategy.md`
  - Prompt specs: `docs/cgf_fgf_prompt_specs.md`
  - Trajectory schema: `probes/cgf_fgf/trajectory_schema.v0.json`
- **OpenRouter harness** to execute Scenario 1 (bail recommendation) with `gpt-4o-mini`:
  - Runner: `harness/openrouter_cgf_fgf.py`
  - Notes: `harness/README.md`
...
Trajectories are **JSONL** with **one line per round**.
